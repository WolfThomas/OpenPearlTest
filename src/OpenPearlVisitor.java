...
public interface OpenPearlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link OpenPearlParser#structuredType}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStructuredType(OpenPearlParser.StructuredTypeContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link OpenPearlParser#bitSelectionSlice}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBitSelectionSlice(OpenPearlParser.BitSelectionSliceContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link OpenPearlParser#charSelectionSlice}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCharSelectionSlice(OpenPearlParser.CharSelectionSliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitNowFunction(OpenPearlParser.NowFunctionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDateFunction(OpenPearlParser.DateFunctionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link OpenPearlParser#stringSlice}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStringSlice(OpenPearlParser.StringSliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCase1BitSlice(OpenPearlParser.Case1BitSliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCase2BitSlice(OpenPearlParser.Case2BitSliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCase3BitSlice(OpenPearlParser.Case3BitSliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCase1CharSlice(OpenPearlParser.Case1CharSliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCase3CharSlice(OpenPearlParser.Case3CharSliceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitCase4CharSlice(OpenPearlParser.Case4CharSliceContext ctx);
	/**
